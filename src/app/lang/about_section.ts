export const about_text = {
  pt: {
    ...
    title: "Ivana Lerea",
    subtitle:
      "Artesã reconhecida, Empreendedora e Mentora de mais de 2.000 alunas.",
  ...
  es: {
    ...
    title: "Ivana Lerea",
    subtitle:
      "Artesana calificada, Emprendedora y Mentora de más de 2,000 alumnas.",
    ...
    boxADesc:
      "Títulos oficiales avalados que respaldan tus talleres ante clientes.",
    boxBTitle: "Cursos Bilingües",
    boxBDesc:
      "Metodología amigable dictada perfectamente en Español y Portugués.",
