export const lead_text = {
  pt: {
    ...
    adminTitle:
      "Painel Admin Local de Leads (Mecanismo Sandbox Postgres Mockup)",
    adminDesc:
      "Esta tabela interna simula os registros gravados em tempo real na tabela PostgreSQL leads. Útil para verificar e aprovar o correto funcionamento de seu formulário comercial!",
  ...
  es: {
    ...
    successMsg:
      "¡Gracias! Recibimos tu solicitud correctamente. Ivana o un asesor técnico te responderá a la brevedad.",
    adminTitle: "Panel de Administración Local (Demostración de Base de Datos)",
    adminDesc:
      "Esta tabla simula los registros guardados en tiempo de ejecución de la base de datos PostgreSQL. ¡Útil para comprobar el flujo comercial antes de subir a producción!",
