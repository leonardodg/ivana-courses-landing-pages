export const home_text = {
  pt: {
    ...
    footerRights:
      "© 2026 Ivana Lerea LTDA. Todos os direitos reservados. CNPJ: 63.991.300/0001-08",
    coursesLabel: "Cursos",
  ...
  es: {
    ...
    footerRights:
      "© 2026 Ivana Lerea LTDA. Reservados todos los derechos. Mapeo internacional de clases en Argentina y Brasil.",
    coursesLabel: "Cursos",
    aboutLabel: "Sobre Mí",
...
export const hero_text = {
  candles: {
    ...
    desc: {
      pt: "Aprenda do zero com a especialista bilingue Ivana Lerea. Cursos presenciais e Online (Plataforma de Ensino) com certificação oficial internacional e foco total em vendas e marca.",
